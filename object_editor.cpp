...
ObjectEditor::ObjectEditor(RenderWindow& window, ResourceManager& resources, ConfigHandler& config) :
    ...
    OverlayData overlay_data(FloatRect(0.0, 0.0, 1.0, 1.0), Color(0, 0, 0, 200), State::MAP_EDIT, true);
    ...
    overlay->AddButton(new TransitionButton(bt_data, window.getSize(), 0.5, 0.9, State::EDITOR_SUITE_MENU));
}

State ObjectEditor::Display() {
